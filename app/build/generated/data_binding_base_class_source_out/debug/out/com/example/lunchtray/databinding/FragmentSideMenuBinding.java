...
public abstract class FragmentSideMenuBinding extends ViewDataBinding {
  ...
  @Bindable
  protected String mSideOne;

  @Bindable
  protected String mSideTwo;

  @Bindable
  protected String mSideThree;

  @Bindable
  protected String mSideFour;
  ...
  public abstract void setSideOne(@Nullable String sideOne);
  ...
  public abstract void setSideTwo(@Nullable String sideTwo);
  ...
  public abstract void setSideThree(@Nullable String sideThree);
  ...
  public abstract void setSideFour(@Nullable String sideFour);
