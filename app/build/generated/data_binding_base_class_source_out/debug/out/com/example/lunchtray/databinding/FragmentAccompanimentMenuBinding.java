...
public abstract class FragmentAccompanimentMenuBinding extends ViewDataBinding {
  ...
  @Bindable
  protected String mAccompanimentOne;

  @Bindable
  protected String mAccompanimentTwo;

  @Bindable
  protected String mAccompanimentThree;
  ...
  public abstract void setAccompanimentOne(@Nullable String accompanimentOne);

  @Nullable
  public String getAccompanimentOne() {
    return mAccompanimentOne;
  }

  public abstract void setAccompanimentTwo(@Nullable String accompanimentTwo);

  @Nullable
  public String getAccompanimentTwo() {
    return mAccompanimentTwo;
  }

  public abstract void setAccompanimentThree(@Nullable String accompanimentThree);

  @Nullable
  public String getAccompanimentThree() {
    return mAccompanimentThree;
  }
