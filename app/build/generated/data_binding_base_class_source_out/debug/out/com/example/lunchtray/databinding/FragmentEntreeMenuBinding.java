...
public abstract class FragmentEntreeMenuBinding extends ViewDataBinding {
  ...
  @Bindable
  protected String mEntreeOne;

  @Bindable
  protected String mEntreeTwo;

  @Bindable
  protected String mEntreeThree;

  @Bindable
  protected String mEntreeFour;
  ...
  public abstract void setEntreeOne(@Nullable String entreeOne);

  @Nullable
  public String getEntreeOne() {
    return mEntreeOne;
  }

  public abstract void setEntreeTwo(@Nullable String entreeTwo);

  @Nullable
  public String getEntreeTwo() {
    return mEntreeTwo;
  }

  public abstract void setEntreeThree(@Nullable String entreeThree);

  @Nullable
  public String getEntreeThree() {
    return mEntreeThree;
  }

  public abstract void setEntreeFour(@Nullable String entreeFour);

  @Nullable
  public String getEntreeFour() {
    return mEntreeFour;
  }
