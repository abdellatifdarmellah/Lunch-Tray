...
public class FragmentAccompanimentMenuBindingImpl extends FragmentAccompanimentMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        else if (BR.accompanimentTwo == variableId) {
            setAccompanimentTwo((java.lang.String) variable);
        }
        else if (BR.accompanimentThree == variableId) {
            setAccompanimentThree((java.lang.String) variable);
        }
        else if (BR.accompanimentOne == variableId) {
            setAccompanimentOne((java.lang.String) variable);
        }
    ...
    public void setAccompanimentTwo(@Nullable java.lang.String AccompanimentTwo) {
        this.mAccompanimentTwo = AccompanimentTwo;
        synchronized(this) {
            mDirtyFlags |= 0x4L;
        }
        notifyPropertyChanged(BR.accompanimentTwo);
        super.requestRebind();
    }
    public void setAccompanimentThree(@Nullable java.lang.String AccompanimentThree) {
        this.mAccompanimentThree = AccompanimentThree;
        synchronized(this) {
            mDirtyFlags |= 0x8L;
        }
        notifyPropertyChanged(BR.accompanimentThree);
        super.requestRebind();
    }
    public void setAccompanimentOne(@Nullable java.lang.String AccompanimentOne) {
        this.mAccompanimentOne = AccompanimentOne;
        synchronized(this) {
            mDirtyFlags |= 0x10L;
        }
        notifyPropertyChanged(BR.accompanimentOne);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        java.lang.String accompanimentTwo = mAccompanimentTwo;
        ...
        switch(sourceId) {
            ...
            case 2: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    viewModel.setAccompaniment(accompanimentTwo);
                }
                break;
            }
            case 5: {
            ...
            case 3: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    viewModel.setAccompaniment(accompanimentThree);
                }
                break;
            }
            case 1: {
                ...
                if (viewModelJavaLangObjectNull) {
                    ...
                    viewModel.setAccompaniment(accompanimentOne);
                }
                break;
            }
        }
    ...
    /* flag mapping
        ...
        flag 2 (0x3L): accompanimentTwo
        flag 3 (0x4L): accompanimentThree
        flag 4 (0x5L): accompanimentOne
