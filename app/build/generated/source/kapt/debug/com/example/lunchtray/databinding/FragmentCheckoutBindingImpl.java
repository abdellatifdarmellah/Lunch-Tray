...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String totalAndroidStringTotalViewModelTotalToString = null;
        ...
        java.lang.String taxAndroidStringTaxViewModelTaxToString = null;
        java.lang.String viewModelEntreeFormattedPrice = null;
        java.lang.String subtotalAndroidStringSubtotalViewModelSubtotalToString = null;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x182L) != 0) {
                    ...
                    subtotalAndroidStringSubtotalViewModelSubtotalToString = subtotal.getResources().getString(R.string.subtotal, viewModelSubtotalToString);
            }
            ...
            if ((dirtyFlags & 0x188L) != 0) {
                    ...
                    totalAndroidStringTotalViewModelTotalToString = total.getResources().getString(R.string.total, viewModelTotalToString);
            }
            ...
            if ((dirtyFlags & 0x1a0L) != 0) {
                    ...
                    taxAndroidStringTaxViewModelTaxToString = tax.getResources().getString(R.string.tax, viewModelTaxToString);
            }
        }
        // batch finished
        if ((dirtyFlags & 0x181L) != 0) {
        ...
        if ((dirtyFlags & 0x182L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.subtotal, subtotalAndroidStringSubtotalViewModelSubtotalToString);
        }
        if ((dirtyFlags & 0x1a0L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tax, taxAndroidStringTaxViewModelTaxToString);
        }
        if ((dirtyFlags & 0x188L) != 0) {
            // api target 1

            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.total, totalAndroidStringTotalViewModelTotalToString);
        }
    }
