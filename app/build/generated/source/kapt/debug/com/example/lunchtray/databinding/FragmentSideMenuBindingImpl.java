...
public class FragmentSideMenuBindingImpl extends FragmentSideMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.sideTwo == variableId) {
            setSideTwo((java.lang.String) variable);
        }
        else if (BR.sideMenuFragment == variableId) {
            setSideMenuFragment((com.example.lunchtray.ui.order.SideMenuFragment) variable);
        }
        else if (BR.sideFour == variableId) {
            setSideFour((java.lang.String) variable);
        }
        else if (BR.sideOne == variableId) {
            setSideOne((java.lang.String) variable);
        }
        else if (BR.sideThree == variableId) {
            setSideThree((java.lang.String) variable);
        }
    ...
    public void setSideTwo(@Nullable java.lang.String SideTwo) {
        this.mSideTwo = SideTwo;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.sideTwo);
        super.requestRebind();
    }
    ...
    public void setSideFour(@Nullable java.lang.String SideFour) {
        this.mSideFour = SideFour;
        synchronized(this) {
            mDirtyFlags |= 0x8L;
        }
        notifyPropertyChanged(BR.sideFour);
        super.requestRebind();
    }
    public void setSideOne(@Nullable java.lang.String SideOne) {
        this.mSideOne = SideOne;
        synchronized(this) {
            mDirtyFlags |= 0x10L;
        }
        notifyPropertyChanged(BR.sideOne);
        super.requestRebind();
    }
    public void setSideThree(@Nullable java.lang.String SideThree) {
        this.mSideThree = SideThree;
        synchronized(this) {
            mDirtyFlags |= 0x20L;
        }
        notifyPropertyChanged(BR.sideThree);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        java.lang.String sideTwo = mSideTwo;
        ...
        java.lang.String sideFour = mSideFour;
        ...
        java.lang.String sideOne = mSideOne;
        ...
        java.lang.String sideThree = mSideThree;
    ...
    /* flag mapping
        ...
        flag 3 (0x4L): sideFour
        flag 4 (0x5L): sideOne
        flag 5 (0x6L): sideThree
